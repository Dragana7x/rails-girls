...
class DonutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post donuts_url, params: { donut: { description: @donut.description, name: @donut.name, picture: @donut.picture } }
    end
  ...
  test "should update donut" do
    patch donut_url(@donut), params: { donut: { description: @donut.description, name: @donut.name, picture: @donut.picture } }
